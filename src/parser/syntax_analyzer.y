...
;
expression
: var ASSIGNMENT expression {$$ = node("expression", 3, $1, $2, $3);}
...
void yyerror(const char * s)
{
    ...
    fprintf(stderr, "error at line %d column %d to column %d: %s\n", lines, pos_start, pos_end, s);
}
